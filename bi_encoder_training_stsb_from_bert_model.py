...
Usage:
python bi_encoder_training_stsb_from_bert_model.py
...
parser.add_argument('--model', dest='model', type=str, help='Name of the word embedding model', default='distilbert-base-uncased')
